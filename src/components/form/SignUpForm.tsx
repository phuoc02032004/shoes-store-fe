    ...
    <div className="flex flex-col  px-4 py-8 lg:px-8 w-auto">
      <div className="w-full items-center justify-center">
        <div className="grid w-full items-center justify-center grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5 mb-6">
          <div className=''>
            <label htmlFor="fullname" className=" block text-[#1F3E97] text-sm font-semibold mb-2">
              Full Name *
            </label>
            <input
          ...
          <div className=''>
            <label htmlFor="username" className=" block text-[#1F3E97] text-sm font-semibold mb-2">
              Username *
            </label>
            <input
              className="appearance-none border-none rounded-lg w-full py-[16px] px-[16px] text-[#858585] font-medium text-sm leading-tight focus:outline-none focus:ring-2 focus:ring-[#1F3E97] bg-[#F1F1F1] placeholder-[#858585]" // Styles from Figma: bg, border-radius, padding, text style
              id="username"
              type="text"
              placeholder="Nguyenphuoc0203" 
            />
          </div>

          <div className=''>
            <label htmlFor="dateofbirth" className=" block text-[#1F3E97] text-sm font-semibold mb-2">
              Date of birth *
            </label>
            <input
              className="appearance-none border-none rounded-lg w-full py-[16px] px-[16px] text-[#858585] font-medium text-sm leading-tight focus:outline-none focus:ring-2 focus:ring-[#1F3E97] bg-[#F1F1F1] placeholder-[#858585]" // Styles from Figma: bg, border-radius, padding, text style
          ...
          <div className=''>
            <div>
              ...
              <input
                ...
                id="address"
                type="text"
                placeholder="Xuan Thoi Dong, Hoc Mon, Ho Chi Minh City" 
              />
            </div>
          </div>
